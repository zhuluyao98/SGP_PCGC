 ...
 public class NeuralNetwork implements OnlineRegression<double[]> {
    ...
    public void learn(double[][] x, double[] y) {
     ...
     public static void main(String[] args){
         ...
         NeuralNetwork.Trainer trainer = new NeuralNetwork.Trainer(3,5,5,5,1);//the number of input, ...the number of nodes in each layer..., the nunmber of output
         NeuralNetwork network = trainer.train(x, y);
