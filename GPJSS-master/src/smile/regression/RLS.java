...
/**
 * added---Recursive least squares (RLS) is an adaptive filter algorithm that
 * recursively finds the coefficients that minimize a weighted linear least squares cost function relating to the input signals.
 *
