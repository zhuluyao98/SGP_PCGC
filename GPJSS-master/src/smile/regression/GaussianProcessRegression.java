...
public class GaussianProcessRegression <T> implements Regression<T> {
    ...
    public static void main(String[] args){
        ...
        GaussianProcessRegression.Trainer<double[]> trainer = new GaussianProcessRegression.Trainer<double[]>(mercerKernel,0.5);
        GaussianProcessRegression<double[]> network = trainer.train(x, y);
