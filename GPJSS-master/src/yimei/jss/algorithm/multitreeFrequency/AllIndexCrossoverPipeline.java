 ...
 * crossover both trees separately
 */
            ...
            if (tree1 == TREE_UNFIXED && tree2 == TREE_UNFIXED && (parents[0].trees.length == parents[1].trees.length)) {
                ...
                for (int t = 0; t < length; t++) {
                    ...
                    for (int x = 0; x < numTries; x++) {
                        ...
                        p11 = nodeselect1.pickNode(state, subpopulation, thread, parents[0], parents[0].trees[t], t, true);

                        // pick a node in individual 2
                        p21 = nodeselect2.pickNode(state, subpopulation, thread, parents[1], parents[1].trees[t], t, false);
