...
public class TestResult {
	...
	//23.9.2022 luyao read sumTrainTime into CSV
	private DescriptiveStatistics generationalSumTrainTimeStat;
	...
	//fzhang 2019.8.24 read the number of clearedInds into CSV
	private DescriptiveStatistics generationalSeqClearedIndsStat;
	private DescriptiveStatistics generationalRouClearedIndsStat;
	...
	//fzhang 2019.8.24 get the the number of cleared inds into CSV --- sequencing
	//===================================start==================================
	public DescriptiveStatistics getsetGenerationalSeqClearedIndsStat() { return generationalSeqClearedIndsStat;}

	public double getsetGenerationalSeqClearedIndsStat(int gen) {
		return generationalSeqClearedIndsStat.getElement(gen);
	}

	//fzhang 2019.8.24 get the the number of cleared inds into CSV --- sequencing
	//===================================start==================================
	public DescriptiveStatistics getsetGenerationalRouClearedIndsStat() { return generationalRouClearedIndsStat;}

	public double getsetGenerationalRouClearedIndsStat(int gen) {
		return generationalRouClearedIndsStat.getElement(gen);
	}
...
//=========================================================================
	...
	//2019.8.24 fzhang read the number of cleared inds into CSV---sequencing
	public void setGenerationalSeqClearedIndsStat(DescriptiveStatistics generationalSeqClearedIndsStat) {
		this.generationalSeqClearedIndsStat = generationalSeqClearedIndsStat;
	}

	//2019.8.24 fzhang read the number of cleared inds into CSV---routing
	public void setGenerationalRouClearedIndsStat(DescriptiveStatistics generationalRouClearedIndsStat) {
		this.generationalRouClearedIndsStat = generationalRouClearedIndsStat;
	}
	...
	//23.9.2022 luyao read sumTrainTime into CSV
	public void setGenerationalSumTrainTimeStat(DescriptiveStatistics generationalSumTrainTimeStat) {
		this.generationalSumTrainTimeStat = generationalSumTrainTimeStat;
	}

	public double getGenerationalSumTrainTimeStatStat(int gen) {
		return generationalSumTrainTimeStat.getElement(gen);
	}
