...
public interface GPNodeSelector extends Prototype 
    ...
    */
    ...
    //fzhang 2019.8.29 pickNode based on some conditions
        public abstract GPNode pickNode(final EvolutionState s,
                                        final int subpopulation,
                                        final int thread,
                                        final GPIndividual ind,
        ...
        //fzhang 2019.9.23 pickNode based on the score (coefficient) related to the subtree type
        public abstract GPNode pickNode(EvolutionState s, int subpopulation, int thread, GPIndividual ind, GPTree tree, int treeType, Boolean flag);
