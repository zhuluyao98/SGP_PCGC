...
public class MultiPopCoevolutionaryEvaluator extends Evaluator
    ...
    //fzhang 2019.8.22 change it to public, in order to use it in reiniMultiPopCoevolutionaryEvaluator
    ...
    //fzhang 2019.8.22 change it to public, in order to use it in reiniMultiPopCoevolutionaryEvaluator
    public SelectionMethod[] selectionMethodPrev;
    ...
    //fzhang 2019.8.22 change it to public, in order to use it in reiniMultiPopCoevolutionaryEvaluator
    public SelectionMethod[] selectionMethodCurrent;
   ...
   //public double fracAdapted;
    ...
    public void evaluatePopulation(final EvolutionState state)
        ...
        //2019.8.24 another constructor of evaluatePopulation---different parameters
        public void evaluatePopulation(final EvolutionState state, ArrayList<double[][]> indsCharLists)
        {
            // determine who needs to be evaluated
          /*  boolean[] preAssessFitness = new boolean[state.population.subpops.length];
            boolean[] postAssessFitness = new boolean[state.population.subpops.length];
            ...
            ((GroupedProblemForm)p_problem).preprocessPopulation(state,state.population, preAssessFitness, false);*/
            performCoevolutionaryEvaluation(state, state.population, (GroupedProblemForm)p_problem, indsCharLists);
        ...
        //2019.8.24 performCoevolutionaryEvaluation with different parameters
        public void performCoevolutionaryEvaluation( final EvolutionState state,
                                                     final Population population,
                                                     final GroupedProblemForm prob,
                                                     ArrayList<double[][]> indsCharLists) {
        }


        //2019.9.12 another constructor of evaluatePopulation---different parameters
        //do not revaluate individuals that have been evaluated
        public void evaluatePopulation(final EvolutionState state, final Boolean clear)
        {
            // determine who needs to be evaluated
            boolean[] preAssessFitness = new boolean[state.population.subpops.length];
            boolean[] postAssessFitness = new boolean[state.population.subpops.length];
            ...
            ((GroupedProblemForm)p_problem).preprocessPopulation(state,state.population, preAssessFitness, false);
            performCoevolutionaryEvaluation( state, state.population, (GroupedProblemForm)p_problem, clear);
        ...
        //2019.9.12 performCoevolutionaryEvaluation with different parameters
        public void performCoevolutionaryEvaluation( final EvolutionState state,
                                                     final Population population,
                                                     final GroupedProblemForm prob,
                                                     Boolean clear) {
